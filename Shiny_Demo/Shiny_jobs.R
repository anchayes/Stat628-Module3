...
# Replace 'Northern Territories' to 'Northern Territory' in state column.
...
# Using state id to merge the map data as same as tutorial (week 6)
state_id <- merge(state_job, data_id, by.x="state", by.y="Region")
state_jobs <- state_id %>% arrange(id)


# Import the data of map as tutorial (week 6)
...
# Most common job sub-classification of information & communication technology. 
